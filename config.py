...
OLLAMA_PULL_CONNECT_TIMEOUT = _get_float("OLLAMA_PULL_CONNECT_TIMEOUT", 10.0, minimum=0.1, maximum=60.0)
OLLAMA_PULL_READ_TIMEOUT = _get_float("OLLAMA_PULL_READ_TIMEOUT", 120.0, minimum=1.0)
MAX_MODEL_NAME_LENGTH = _get_int("MAX_MODEL_NAME_LENGTH", 200, minimum=8, maximum=512)
